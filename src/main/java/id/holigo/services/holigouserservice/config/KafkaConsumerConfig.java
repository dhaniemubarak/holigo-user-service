...
public class KafkaConsumerConfig {
    ...
    public KafkaListenerContainerFactory
            <ConcurrentMessageListenerContainer<String, UpdateUserEmailStatusDto>> factory(ConsumerFactory<String, UpdateUserEmailStatusDto> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, UpdateUserEmailStatusDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
